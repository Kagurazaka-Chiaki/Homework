#ifndef EPSILON_MATH_MATRIX_MAT2X3_HPP
#define EPSILON_MATH_MATRIX_MAT2X3_HPP
...
namespace epsilon::math {
    ...
    struct Mat<T, 2, 3> : MatrixBase<Mat<T, 2, 3>, T, 2, 3> {
        using Base = MatrixBase<Mat<T, 2, 3>, T, 2, 3>;
...
#endif // EPSILON_MATH_MATRIX_MAT2X3_HPP
