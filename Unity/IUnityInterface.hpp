...
#ifndef UNITY_IUNITYINTERFACE_HPP
#define UNITY_IUNITYINTERFACE_HPP
...
struct UnityInterfaceGUID {
    ...
    UnityInterfaceGUID(UnityInterfaceGUID const &other) {
        m_GUIDHigh = other.m_GUIDHigh;
        m_GUIDLow  = other.m_GUIDLow;
    }

    UnityInterfaceGUID &operator=(UnityInterfaceGUID const &other) {
        m_GUIDHigh = other.m_GUIDHigh;
        m_GUIDLow  = other.m_GUIDLow;
        return *this;
    }

    bool Equals(UnityInterfaceGUID const &other) const { return m_GUIDHigh == other.m_GUIDHigh && m_GUIDLow == other.m_GUIDLow; }

    bool LessThan(UnityInterfaceGUID const &other) const { return m_GUIDHigh < other.m_GUIDHigh || (m_GUIDHigh == other.m_GUIDHigh && m_GUIDLow < other.m_GUIDLow); }
#endif
    unsigned long long m_GUIDHigh;
    unsigned long long m_GUIDLow;
};
#ifdef __cplusplus
inline bool operator==(const UnityInterfaceGUID &left, const UnityInterfaceGUID &right) {
    return left.Equals(right);
}

inline bool operator!=(UnityInterfaceGUID const &left, UnityInterfaceGUID const &right) {
    return !left.Equals(right);
}
...
inline UnityInterfaceGUID const GetUnityInterfaceGUID();
...
#endif // UNITY_IUNITYINTERFACE_HPP