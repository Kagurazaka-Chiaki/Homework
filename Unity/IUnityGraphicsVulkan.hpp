#ifndef UNITY_IUNITYGRAPHICSVULKAN_HPP
#define UNITY_IUNITYGRAPHICSVULKAN_HPP
...
VkImageSubresource const *const UnityVulkanWholeImage = NULL;
...
UNITY_DECLARE_INTERFACE(IUnityGraphicsVulkanV2) {
    ...
    PFN_vkVoidFunction(UNITY_INTERFACE_API * InterceptVulkanAPI)(char const *name, PFN_vkVoidFunction func);

    // Change the precondition for a specific user-defined event
    // Should be called during initialization
    void(UNITY_INTERFACE_API * ConfigureEvent)(int eventID, UnityVulkanPluginEventConfig const *pluginEventConfig);
    ...
    bool(UNITY_INTERFACE_API * AccessTexture)(void *nativeTexture, VkImageSubresource const *subResource, VkImageLayout layout, VkPipelineStageFlags pipelineStageFlags, VkAccessFlags accessFlags, UnityVulkanResourceAccessMode accessMode, UnityVulkanImage *outImage);

    bool(UNITY_INTERFACE_API * AccessRenderBufferTexture)(UnityRenderBuffer nativeRenderBuffer, VkImageSubresource const *subResource, VkImageLayout layout, VkPipelineStageFlags pipelineStageFlags, VkAccessFlags accessFlags, UnityVulkanResourceAccessMode accessMode, UnityVulkanImage *outImage);

    bool(UNITY_INTERFACE_API * AccessRenderBufferResolveTexture)(UnityRenderBuffer nativeRenderBuffer, VkImageSubresource const *subResource, VkImageLayout layout, VkPipelineStageFlags pipelineStageFlags, VkAccessFlags accessFlags, UnityVulkanResourceAccessMode accessMode, UnityVulkanImage *outImage);
    ...
    // Must be called before kUnityGfxDeviceEventInitialize (preload plugin)
    bool(UNITY_INTERFACE_API * ConfigureSwapchain)(UnityVulkanSwapchainConfiguration const *swapChainConfig);

    // see AccessTexture
    // Accepts UnityTextureID (UnityRenderingExtTextureUpdateParamsV2::textureID, UnityRenderingExtCustomBlitParams::source)
    bool(UNITY_INTERFACE_API * AccessTextureByID)(UnityTextureID textureID, VkImageSubresource const *subResource, VkImageLayout layout, VkPipelineStageFlags pipelineStageFlags, VkAccessFlags accessFlags, UnityVulkanResourceAccessMode accessMode, UnityVulkanImage *outImage);
...
#endif // UNITY_IUNITYGRAPHICSVULKAN_HPP
