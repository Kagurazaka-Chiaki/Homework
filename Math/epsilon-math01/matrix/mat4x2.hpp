#ifndef EPSILON_MATH_MATRIX_MAT4X2_HPP
#define EPSILON_MATH_MATRIX_MAT4X2_HPP
...
namespace epsilon::math {
    ...
    struct Mat<T, 4, 2> : MatrixBase<Mat<T, 4, 2>, T, 4, 2> {
        using Base = MatrixBase<Mat<T, 4, 2>, T, 4, 2>;
...
#endif // EPSILON_MATH_MATRIX_MAT4X2_HPP
